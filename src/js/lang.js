const homeTexts = {
  ...
  'advantages_pre-title-2': {
    ua: 'Пропоную тільки найкращі варіанти з оренди',
    ru: 'Забота о клиенте',
  ...
  'advantages_pre-title-4': {
    ...
    pl: 'Kalkulacja miesięcznego czynszu',
    en: 'Monthly rental calculation',
  },
  'advantages_pre-title-5': {
    ua: 'В мене найбільша база оренди в Варшаві під офіс або склад',
    ru: 'Доступ ко всем офисным домам в Варшаве',
    pl: 'Dostęp do wszystkich biurowców w Warszawie',
    en: 'Access to information of available office spaces in Warsaw',
  },
  about_title: {
    ua: 'Я найкращій на ринку комерційної нерухомості',
    ru: 'Я лучший на рынке коммерческой недвижимости',
    pl: 'O mnie',
    en: 'About me',
  },
  // about_name: {
