...
const homeTexts = {
  ...
  'my-services-desc-1': {
    ua: 'Оренда офісів в офісних будівлях - бюджетні варіанти з простою та традиційною інфраструктурою',
    ru: 'Аренда офисов в офисных зданиях – бюджетные варианты с простой и традиционной инфраструктурой',
    pl: 'Wynajem biur w budynkach biurowych – ekonomiczne opcje z prostą i tradycyjną infrastrukturą',
    en: 'Renting offices in office buildings - budget options with simple and traditional infrastructure',
  },
  'my-services-desc-2': {
    ua: 'Оренда офісів в бізнес-центрах, які розташовані у ділових районах та поблизу транспортних вузлів',
    ru: 'Аренда офисов в бизнес-центрах, расположенных в деловых районах и вблизи транспортных узлов',
    pl: 'Wynajem biur w centrach biznesowych zlokalizowanych w dzielnicach biznesowych i w pobliżu węzłów komunikacyjnych',
    en: 'Renting offices in business centers located in business districts and near transport hubs',
  },
  'my-services-desc-3': {
    ua: 'Оренда офісів в хмарочосах Варшави, які є найбільш престижними і пропонують панорамні види на місто',
    ru: 'Аренда офисов в небоскребах Варшавы, наиболее престижных и предлагающих панорамные виды на город',
    pl: 'Wynajmij biura w najbardziej prestiżowych warszawskich wieżowcach, z których rozpościera się panoramiczny widok na miasto',
    en: 'Rent offices in Warsaw`s most prestigious skyscrapers offering panoramic views of the city',
  },
  'my-services-desc-4': {
