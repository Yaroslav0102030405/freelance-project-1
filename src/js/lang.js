const homeTexts = {
  ...
  'service_description-2-2': {
    ...
    pl: 'Dostępna jest baza danych właścicieli/operatorów Magazynów w Polsce posiadających lokale biurowe.',
  ...
  about_description5: {
    ...
    pl: 'Mam rzetelną i przejrzystą relację ze swoimi klientami, a także mam dostęp do dużej bazy nieruchomości, co pozwala mi szybko znaleźć lokale do wynajęcia, których potrzebują moi klienci.',
  ...
  about_description7: {
    ...
    pl: 'Jestem gotowy pomóc Ci znaleźć idealną lokalizację!',
