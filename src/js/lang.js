...
const homeTexts = {
  ...
  'service_title-1': {
    ...
    ru: 'Подбор офиса в Варшаве для аренды',
    pl: 'Wybór biura w Warszawie do wynajęcia',
    en: 'Selecting an office in Warsaw for rent',
  },
  'service_desc-1-1': {
  ...
  'service_title-2': {
    ua: 'Підбір складу у Польщі для оренди',
    ru: 'Подбор склада в Польше для аренды',
    pl: 'Wybór magazynu w Polsce do wynajęcia',
    en: 'Selection of a warehouse in Poland for rent',
  },
  'service_desc-2-1': {
  ...
  'my-services-desc-1': {
    ...
    ru: 'Глубокая экспертиза на рынке коммерческой недвижимости Варшавы',
    pl: 'Głęboka wiedza na temat warszawskiego rynku nieruchomości komercyjnych',
    en: 'In-depth expertise in the Warsaw commercial real estate market',
  },
  'my-services-desc-2': {
  ...
  'my-services-desc-4': {
    ua: 'Повний юридичний та консультаційний супровід до моменту отримання ключів',
    ru: 'Полное юридическое и консультационное сопровождение до момента получения ключей',
    pl: 'Pełne wsparcie prawne i doradcze aż do momentu odbioru kluczy',
    en: 'Full legal and consulting support until you receive the keys',
  },
  'my-services-desc-5': {
