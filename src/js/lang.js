...
const homeTexts = {
  ...
  contacts_logo: {
    ua: 'Загалом я успішно допоміг понад 50 різним компаніям знайти для них офіс під оренду. І я з радістю і Вам допоможу!',
    ru: 'В общем я успешно помог более 50 разным компаниям найти для них офис под аренду. И я с радостью и вам помогу!',
    pl: 'W sumie z powodzeniem pomogłem ponad 50 różnym firmom znaleźć powierzchnię biurową do wynajęcia. Chętnie pomogę również Tobie!',
    en: 'In total, I have successfully helped over 50 different companies find office space for rent. And I will be happy to help you too!',
  },
  // contacts_logo1: {
  ...
  contacts_logo2: {
    ...
    ru: 'Бесплатный выбор офисов в Варшаве под ваши индивидуальные потребности',
